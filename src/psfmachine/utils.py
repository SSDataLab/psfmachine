...
def _make_A_edges(r, f, poly_order=1):
    """
    Creates a design matrix to estimate the PSF edge as a apolynomial function of the
    flux.

    Parameters
    ----------
    r : numpy ndarray
        Array with radii values in arcseconds
    f : numpy ndarray
