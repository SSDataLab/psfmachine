...
def test_ffi_from_file():
    ...
    img_shape = ffi.image_shape
    assert ffi.flux.shape == (1, img_shape[0] * img_shape[1])
    assert ffi.flux_2d.shape == (1, *img_shape)
    assert ffi.flux_err.shape == (1, img_shape[0] * img_shape[1])
    assert ffi.column.shape == (img_shape[0] * img_shape[1],)
    assert ffi.row.shape == (img_shape[0] * img_shape[1],)
    assert ffi.ra.shape == (img_shape[0] * img_shape[1],)
    assert ffi.dec.shape == (img_shape[0] * img_shape[1],)
